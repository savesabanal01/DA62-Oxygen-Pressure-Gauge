Diamond Aircraft DA62 Flight Simulator Oxygen Pressure Gauge based on the XPLPro Plugin and X-Plane using a Raspberry Pi Pico microcontroller and a 1.28 in LCD screen to render the gauge.
